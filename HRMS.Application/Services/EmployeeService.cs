...
public class EmployeeService : IEmployeeService
{
    ...
    {
        // Pseudocode / Plan:
        // 1. If caller is Admin:
        //    - Load HR identity user by id
        //    - Validate role and organization
        //    - Update identity fields and persist
        //    - Return mapped DTO
        // 2. Else if caller is HR:
        //    - Load Employee entity by id
        //    - Validate ownership (CreatedBy)
        //    - Normalize phone number
        //    - Check for email/phone uniqueness against repository (excluding current employee)
        //    - Load corresponding Identity user (may be null)
        //    - If identity user exists, update identity fields and persist
        //    - Update Employee entity fields and persist
        //    - Only assign updated.User when identityUser is non-null to avoid null assignment (fix CS8601)
        //    - Return mapped DTO
        // 3. Otherwise return unauthorized
        ...
        else if (callerRole == AppConstants.Roles.HR)
        {
            ...
            // Fix CS8601: only assign when identityUser is non-null
            if (identityUser != null)
            {
